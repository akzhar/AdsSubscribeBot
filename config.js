...
if (isDeploy) {
  ...
  dbOptions.connectionString = `postgres://zmefxsjmjzxdjm:c842fecda2d149f51de92ab5a481b098955566e4f62760f51f34a3e3dd04c053@ec2-34-197-212-240.compute-1.amazonaws.com:5432/d9tfpomnjme45n?ssl=true` // process.env.DATABASE_URL;
  dbOptions.ssl = true;
} else {
